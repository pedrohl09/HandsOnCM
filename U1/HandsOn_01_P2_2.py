# -*- coding: utf-8 -*-
"""
Created on Sat Oct 26 23:39:02 2024
...
# Plot da REM sem shadowing
plt.figure()
plt.pcolor(mtPosx, mtPosy, mtPowerFinaldBm, shading='auto', cmap='hsv')
plt.colorbar()
fDrawDeploy(dR, vtBs)
plt.axis('equal')
plt.title('Todas as 7 ERB sem shadowing')

# Plot da REM com shadowing
plt.figure()
plt.pcolor(mtPosx, mtPosy, mtPowerFinalShaddBm, shading='auto', cmap='hsv')
plt.colorbar()
fDrawDeploy(dR, vtBs)
plt.axis('equal')
plt.title('Todas as 7 ERB com shadowing')

# Plot da REM com shadowing correlacionado
plt.figure()
plt.pcolor(mtPosx, mtPosy, mtPowerFinalShadCorrdBm, shading='auto', cmap='hsv')
plt.colorbar()
fDrawDeploy(dR, vtBs)
plt.axis('equal')
plt.title('Todas as 7 ERB com shadowing correlacionado')
