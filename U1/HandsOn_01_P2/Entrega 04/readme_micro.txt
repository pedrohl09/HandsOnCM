Este projeto simula a cobertura de microcélulas e ERBs (Estações Rádio Base) em uma grade hexagonal, usando o modelo de propagação Okumura-Hata para calcular a potência de sinal recebida em uma área urbana e determinar a cobertura de ERBs em frequências específicas e um modelo de Path Loss fornecido para calcular a potência de sinal recebida em uma área urbana e determinar a cobertura de microcélulas.
...
Com as bibliotecas instaladas, navegue até a pasta onde o arquivo "HandsOn_01_P2_5(Micro).py" está localizado utilizando o comando "cd /caminho/para/sua/pasta". Após acessar o diretório correto, execute o script com o comando "python HandsOn_01_P2_5(Micro).py" (ou "python3 HandsOn_01_P2_5(Micro).py" se estiver utilizando Python 3). Caso ocorra algum erro relacionado ao pip, utilize o comando "python -m ensurepip --upgrade" para atualizá-lo.
